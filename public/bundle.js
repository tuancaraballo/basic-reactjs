...
ReactDOM.render(React.createElement(Greeter, { name: country, sms: msg }), document.getElementById('app'));
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				'div',
				null,
				React.createElement('textarea', { rows: '4', cols: '50', ref: 'textMessage', placeholder: 'Enter message' })
			),
			React.createElement(
				'div',
				null,
